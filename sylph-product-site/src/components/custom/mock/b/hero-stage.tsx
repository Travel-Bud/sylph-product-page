...
/* The landing's copy of v2-sides/hero-stage.tsx (2026-09-25 copy pass): the same playable hero, without the
   "Run a sample month" link, since the landing no longer carries the sample month. */

import { useCallback, useEffect, useLayoutEffect, useRef, useState } from "react";
import { Mark } from "@/components/custom/site/mark";
import { CHARGE, DANA, PRIYA, ROWS, VERDICT_LABEL, type EngineRow } from "@/components/custom/v2-sides/data";
import { Figure, Person, Sample, Tick, VerdictChip } from "@/components/custom/v2-sides/parts";
import { hush, play as sound } from "@/components/custom/v2-sides/sound";
